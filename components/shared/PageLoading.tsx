...
function SectionSkeleton() {
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 px-0 py-6 md:py-10 lg:py-16">
      <section className="space-y-3 pt-4 lg:pt-20">
        <Block className="h-4 w-28 rounded-full" />
        <Block className="h-16 w-[min(86vw,52rem)] rounded-2xl sm:h-20 lg:h-24" />
        <Block className="h-16 w-[min(92vw,44rem)] rounded-2xl sm:h-20 lg:h-24" />
      </section>

      <section className="grid gap-6 md:grid-cols-[1fr_1.2fr] md:items-start">
        ...
        <div className="space-y-3 pt-2">
          ...
          <Block className="h-4 w-8/12 rounded-full" />
        </div>
      </section>
...
export function PageLoading() {
  ...
  if (pathname === "/about" || pathname === "/creative") {
