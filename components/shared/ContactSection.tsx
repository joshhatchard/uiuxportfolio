    ...
    <section className="page-container mt-8 md:mt-12 lg:mt-16 border-t border-white/10 pt-14 lg:pt-24">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-8 flex justify-center">
            ...
            style={{
                background: copied ? "var(--color-primary)" : "var(--color-secondary)",
                color: copied ? "var(--color-secondary)" : "var(--color-bg-black)",
            }}
            >
            ...
            {copied ? (
              ...
              <svg width="20" height="20" viewBox="0 0 20 20" aria-hidden="true">
                <path d="M4 10l4.5 4.5L16 6" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
              </svg>
            ) : (
              // Copy icon
              <svg width="20" height="20" viewBox="0 0 20 20" aria-hidden="true">
                <path d="M18.332 16.667V8.334C18.332 7.417 17.582 6.667 16.665 6.667H8.332C7.415 6.667 6.665 7.417 6.665 8.334V16.667C6.665 17.584 7.415 18.333 8.332 18.333H16.665C17.582 18.333 18.332 17.584 18.332 16.667ZM8.332 16.667V8.334H16.665V16.667H8.332Z" fill="currentColor" />
                <path d="M3.332 11.667V3.334H11.665V5H13.332V3.334C13.332 2.417 12.582 1.667 11.665 1.667H3.332C2.415 1.667 1.665 2.417 1.665 3.334V11.667C1.665 12.584 2.415 13.333 3.332 13.333H4.999V11.667H3.332Z" fill="currentColor" />
              </svg>
            )}
          </button>
