...
const storyTiles: StoryTile[] = [
  {
    ...
    body: "I'm currently studied Design and Computer Science at USYD and honestly it's just clicked. I've been hooked ever since, deep in startups, coding and building things people actually enjoy using.",
    textAbove: false,
  },
  {
  ...
  },
  {
    ...
    body: "I'm always chasing the view. Beautiful landscapes and places that stop you in your tracks. I travel for those moments and snap and quick photo while I'm there.",
    textAbove: false,
  },
  {
    ...
    body: "The beach is where I feel complete. Just the water and the sun. Other than that you'll find me at the gym, driving, exploring random places and picking up whatever new skill catches my eye.",
    textAbove: true,
  },
];
